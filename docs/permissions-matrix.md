...
| generate | Yes | No | No | No | No |
| approveRepair | Yes | No | No | No | No |
| publish | Yes | No | No | No | No |

## Scope rules

- **Department-level access (coordinator):** a coordinator may view and edit only courses, cohorts, assignments, lecturer availability summaries and constraints that belong to their department. They may review departmental conflicts and the departmental timetable. They cannot generate, repair, or publish the university timetable.
